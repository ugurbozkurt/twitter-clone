...
export default function Post({ post }) {
  return (
    <div className="px-4 py-3 border-b border-[color:var(--hv-color-primary)] text-[color:var(--font-color-primary)] flex hover:bg-[color:var(--hv-color-primary)] cursor-pointer ">
      <img
      ...
      <div className="flex-1 px-2">
        <header className="leading-5 flex items-center gap-1">
          <a href={post.account.username} className="hover:underline flex items-center font-bold">
          ...
          <div className="text-[color:var(--color-base-secondary)] flex items-center gap-1.5 ">
            ...
            <div className="w-0.5 h-0.5 rounded-full bg-[color:var(--font-color-primary)]"></div>
            <div className="text-[14px]">17s</div>
          </div>
        </header>
